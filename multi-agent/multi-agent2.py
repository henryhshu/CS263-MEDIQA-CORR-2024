...
if __name__ == "__main__":
    cfg = LLMConfig(model="gpt-5.2", temperature=0.0, max_output_tokens=600)
    ...
    out_path = out_dir / f"medec-ms_{orch.cfg.model}_multi-agent_results_{datetime.now().strftime('%Y%m%d_%H%M%S')}.txt"
